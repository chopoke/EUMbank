  ...
  return (
    <div className="agreement-container" style={styles.container}>
      <p>
        금융투자회사 경영공시<br />
        <br />
        이음은행 (이하 '회사'라 한다)는 「자본시장과 금융투자업에 관한 법률」 및 관련 규정에 따라 회사의 건전성 및 경영 상황을 투명하게 공개합니다.<br />
        <br />

        공시 기준일: 2025년 10월 20일 (가장 최근 분기 말 기준)<br />
        ...
        본점 주소: 서울특별시 마포구 백범로 23 케이터틀 3층<br />

        설립일: 2025년 10월 20일<br />
        ...
        총자산: 1,000,000,000,000<br />

        총부채: 100,000,000<br />

        자본총계: 999,900,000,000<br />
        <br />

        손익 현황<br />

        영업수익: 1,000,000,000<br />

        영업비용: 100,000,000<br />

        당기순이익(손실): 100,000,000,000<br />
        <br />
        제3조(자본 적정성 및 건전성)<br />
        <br />
        ...
        이사회 구성: 사외이사 5명, 상임이사 8명 등 총 13명으로 구성<br />
        ...
        <br />
        (참고)<br />
        본 공시 내용의 세부 사항 및 최신 정보는 회사의 홈페이지 (support@E-UMbank.com) 또는 금융감독원 전자공시 시스템(DART)을 통해 확인하실 수 있습니다.<br />
        <br />
        <br />
        이음은행<br />
      </p>
