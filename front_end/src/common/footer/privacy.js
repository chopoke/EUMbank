  ...
  return (
    <div className="agreement-container" style={styles.container}>
      <p>
        금융투자회사 개인정보 처리방침<br />
        <br />
        이음은행 (이하 '회사'라 한다)는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br />
        <br />

        이 방침은 2025년 10월 20일부터 시행됩니다.<br />
        ...
        연락처: 010-0000-0000, support@E-UMbank.com<br />
        <br />
        ...
        <br />
        이 개인정보 처리방침은 2025년 10월 20일부터 적용됩니다. 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 회사의 홈페이지 등을 통하여 고지할 것입니다.<br />
        <br />
        <br />
        (부칙)<br />
        이 방침은 2025년 10월 20일부터 시행합니다.<br />
      </p>
    </div>
  );
};
