...
import { fetchDepositDetail, fetchDepositTransactions } from "../../api/accounts";
...
function DepositHistoryPage() {
  ...
  React.useEffect(() => {
    if (!d_no) return;
    fetchDepositDetail(Number(d_no))
      .then((res) => {
        const d = res.data;
  ...
  React.useEffect(() => {
    ...
    fetchDepositTransactions(Number(d_no), {
      type,
  ...
  function downloadCsv(list) {
    ...
    a.href = url;
    a.download = "deposit_history.csv";
    a.click();
  ...
  async function downloadPdf(list) {
    ...
    doc.save(`DepositHistory-${Date.now()}.pdf`);
  }
