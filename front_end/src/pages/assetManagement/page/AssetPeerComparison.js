            ...
            <div className="rounded-md border border-gray-200 bg-gray-50 p-4 flex flex-col gap-4">
              ...
              <ul className="text-sm text-gray-700 space-y-3">
                <li className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">30대 초반</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-[12px] text-gray-500">월 소득</span>
                  <span className="font-medium text-gray-900">380만 원</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-[12px] text-gray-500">거주 지역</span>
                  <span className="font-medium text-gray-900">서울</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-[12px] text-gray-500">투자 성향</span>
                  <span className="font-medium text-gray-900">중간 위험 선호</span>
                </li>
              </ul>
