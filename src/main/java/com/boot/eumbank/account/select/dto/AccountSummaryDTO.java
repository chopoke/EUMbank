...
public class AccountSummaryDTO {
    ...
    @JsonProperty("a_balance")      private BigDecimal balance;         // 잔액
    @JsonProperty("a_nickname")     private String nickname;            // 별칭
    @JsonProperty("a_status")       private String status;              // 상태
    @JsonProperty("a_rate")         private BigDecimal rate;            // 이율
