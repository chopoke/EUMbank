...
public class FinlifeJeonseResponseDTO {
    ...
    public static class Result {
        ...
        @JsonProperty("now_page_no") private Integer nowPageNo;     // 현재페이지
    ...
    public static class Base {
        ...
        @JsonProperty("join_way")    private String joinWay;        // 가입 방법
        ...
        @JsonProperty("loan_lmt")    private String loanLmt;        // 대출한도 
    ...
    public static class Option {
        ...
        @JsonProperty("mrtg_type_nm")     private String mrtgTypeNm;        // 담보 유형명-->주택담보용
        @JsonProperty("rpay_type_nm")     private String rpayTypeNm;        // 대출상환유형명
        @JsonProperty("lend_rate_type_nm")private String lendRateTypeNm;    // 대출금리유형
        ...
        @JsonProperty("lend_rate_avg")    private BigDecimal lendRateAvg;       // 글미평균
    }
}
