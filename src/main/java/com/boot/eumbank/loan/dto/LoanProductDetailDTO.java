...
public class LoanProductDetailDTO {
    ...
    private Integer ltvMax;         // % (null 허용)  -> 신용대출은 null
    ...
    public static class RateOption {
        private String rpayTypeNm;          // 상환 타입
        private String lendRateTypeNm;      // 금리 타입
        private BigDecimal lendRateMin;     // 최소금리
        private BigDecimal lendRateMax;     // 최대금리
