...
import static com.boot.eumbank.product.entity.product.QProductForeignList.productForeignList;
    ...
    public List<ProductDto> findForeignProducts() {
        return queryFactory
                .select(Projections.constructor(ProductDto.class,
                        ...
                        productForeignList.fpFeature,
                        productForeignList.fpHref,
                        productForeignList.fpButtonText,
