...
/**
 * 현물거래 지갑 정보를 전달하기 위한 DTO입니다.
 * 목적: API 응답에서 지갑 정보 전달
 * 사용: 컨트롤러 → 프론트엔드 지갑 데이터 전달에 사용됩니다.
 */
import java.math.BigDecimal;
import java.time.LocalDateTime;

public class GoldWalletDto {
    public Integer gwNo; /** 지갑 번호 */
    public Integer customerNo; /** 고객 번호 */
    public String walletName; /** 지갑 이름 */
    public String accountNo; /** 현물계좌 통장 계좌번호 */
    public String pin; /** 지갑 PIN 번호 */
